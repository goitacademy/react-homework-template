...
[React React App](https://github.com/facebook/create-react-app). Для более
...
- Установи базовые зависимости проекта коммандой `npm install`
- Запусти режим разработки, выполнив комманду `npm start`
- Перейди в браузере по адресу [http://localhost:3000](http://localhost:3000).
  Эта страница будет автоматически перезагружаться каждый раз после сохранения
  изменений кода проекта.
